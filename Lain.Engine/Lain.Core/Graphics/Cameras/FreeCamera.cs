    ...
    public class FreeCamera : Camera
    {
        ...
        private void RotateWithMouse()
        {
            ...
            if (!(RotateOnPress && !mouseState.RightButton) && mouseState.X >= 0 && mouseState.Y >= 0)
            {
                ...
                if (Math.Abs(deltaX) < MathHelper.ZeroTolerance && Math.Abs(deltaY) < MathHelper.ZeroTolerance)
                    return;
        ...
        public override void Update()
        {
            ...
            Transform.Rotation = new Vector3(Transform.Rotation.X%MathHelper.TwoPi,
                Transform.Rotation.Y%MathHelper.TwoPi, 0);
