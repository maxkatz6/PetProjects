...
namespace Lain.GAPI
{
    public class Render : Disposable
    {
        private IntPtr _lastVB, _lastIB;
        protected BlendState AlphaBlendingTrue, AlphaBlendingFalse;
        protected DepthStencilState DepthStencilStateTrue, DepthStencilStateFalse;
        ...
        public int ShaderModel { get; protected set; }

        public static Render Create(object handle)
        {
        ...
        public void ZBuffer(bool isDepthEnabled)
        {
            ...
            DeviceContext.OutputMerger.SetDepthStencilState(
                isDepthEnabled ? DepthStencilStateTrue : DepthStencilStateFalse, 1);
        ...
        {
            DeviceContext.Rasterizer.SetScissorRectangle(l,t,r,b);
        }
    }
}
