var sConfig={
    ...
    statImg:[
        ...
        '12.png', '13.png', '14.png', '15.png', '16.png', '17.png', '18.png',   '19.png',   '20.png',   '21.png', 'webcam.png',   '23.png'
    ],
    statText:[
        'На месте', 'Нет на месте', 'Скоро буду', 'На работе', 'На учёбе',
        'Болею', 'Играю', 'Смотрю кино', 'Слушаю музыку',
        'Читаю', 'Пьяненький', 'Перекур', 'Кушаю', 'Сплю',  'Творю', 'Отдыхаю','Веселюсь','Хочу убивать','Безудержное веселье','Превед, медвед!','На проводе','Подключен к видеоканалу','--'
    ]
};