...
namespace TDF.WinFormsPanel
{
    /// <summary>
    /// </summary>
    public partial class DirectXPanel : RenderControl, IShutdown
    {
        public Action Draw;
    ...
    {
        public static SharpDX.Color ToColor(this System.Drawing.Color inputColor)
        {
            return new SharpDX.Color(inputColor.R, inputColor.G, inputColor.B, inputColor.A);
        }
    }
}
